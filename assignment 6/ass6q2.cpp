...
int main()
{
    ...
    cout << "Enter the Information for Emp" << endl;
    cout << "********************************************" << endl;
    e.accept();
    cout << "----------------------------------------------" << endl;
    e.display();

    cout << "Enter the Information for Mgr" << endl;
    cout << "********************************************" << endl;
    m.accept();
    cout << "----------------------------------------------" << endl;
    m.display();

    cout << "Enter the Information for SalesMan " << endl;
    cout << "********************************************" << endl;
    s.accept();
    cout << "----------------------------------------------" << endl;
    s.display();

    cout << "Enter the Information for SalesManager" << endl;
    cout << "********************************************" << endl;
    sm.accept();
    cout << "----------------------------------------------" << endl;
    sm.display();
